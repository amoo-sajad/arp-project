...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    user_lat = models.DecimalField(_('user lat'), max_digits=9, decimal_places=6, blank=True, null=True)
    user_long = models.DecimalField(_('user long'), max_digits=9, decimal_places=6, blank=True, null=True)
